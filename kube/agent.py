...
root_agent = Agent(
    ...
    tools=[list_namespaces, list_deployments_from_namespace, list_pods_from_namespace, list_services_from_namespace, list_all_resources, get_deployment_details, get_pod_details, scale_deployment, get_pod_logs, get_resource_health, get_events],
)
